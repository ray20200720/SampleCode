...
set ProjectDIR=D:\Ray\MyProject\GitHub\ray20200720\SampleCode\ASP.NET\CSharp
...
%FrameworkDIR%\v4.0.30319\csc.exe /out:Duck.dll /t:library DataObject\Duck.cs
%FrameworkDIR%\v4.0.30319\csc.exe /out:MallardDuck.dll /t:library DataObject\MallardDuck.cs /R:Duck.dll
%FrameworkDIR%\v4.0.30319\csc.exe /out:Program.exe /R:Duck.dll /R:MallardDuck.dll Program.cs
